...
.days{
  ...
  <body>
	...
	<?php
	 ...
	 $query="select * from t104 where c13='$branch' order by c22 desc;"; 
...
$link='';
	...
	if (mysqli_num_rows($result) > 0) {
				...
				echo "<td><input type='button' class='btn  btn-success' value='update' id='$link' title='c22' name='t104'></td>";
				echo "<td><img src='images/cancel.png'  class='cancel_icon' id='$link' title='c22' value='60'  name='t104'></td></tr>";
				}

...
.days{
  ...
  <body>
			...
			<li class="active">
             ...
             <a href="#manage" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">MANAGE</a>
              <ul class="collapse list-unstyled" id="manage">
                ...
                <li>
                    <a href="addemployee.php">Inventory</a>
                </li>
				<li>
                    <a href="addemployee.php">CASH Registers</a>
                </li>
	...
	<h3 style='text-align:center;'><b>Inventory Category</b></h3>
	<form action='branch.php' method='POST'>
		<table class='table table-hover' id='users-table'>
	<?php
	
	if(isset($_POST['1-c58']))
	{
...
$link='';
	...
	if (mysqli_num_rows($result) > 0) {
				...
				echo "<td><input type='button' class='btn  btn-success' value='update' id='$link' title='c57' name='t108'></td>
				<td><img src='images/cancel.png'  class='cancel_icon' id='$link' title='c57' value='60'  name='t108'></td></tr>";

...
<html lang="en">
  ...
  <body>
	...
	<h3 style='text-align:center;'><b>ADD Inventory Category</b></h3>
	<form action="category_insert.php" method='POST'>
		
	
	 <div class="form-group">
			<label for='name'><b></b>Inventory Category</label>
			<input type='text' class='form-control' placeholder='Enter Inventory Category' name='name' required>
			</div>
		
 <div class="form-group">
			<label for='desc'><b></b>Inventory Category Description</label>
			<input type='text' class='form-control' placeholder='Enter Inventory Category Description' name='desc'>
			</div>
  ...
  if(isset($_POST['name']))
{
	...
	$desc=$_POST['desc'];
	//$data=array();
	$query="insert into t108(c58,c59) values ('$name','$desc')";
